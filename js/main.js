...
$(function() {
  var bookmark = {
    data: [{
      name: '苦蒂网',
      link: 'https://kudi139.github.io/grzy/',
      icon: 'img/log.png',
    }, {
      name: '优惠券',
...
var time = d.getHours();
if (time < 24) {
  document.getElementById("title").innerHTML = "万能导航 | Good evening";
}
if (time < 18) {
  document.getElementById("title").innerHTML = "万能导航 | Good afternoon";
}
if (time < 12) {
  document.getElementById("title").innerHTML = "万能导航 | Good morning";
}
if (time < 5) {
  document.getElementById("title").innerHTML = "万能导航 | Stay up late again";
}
//title问候语结束
